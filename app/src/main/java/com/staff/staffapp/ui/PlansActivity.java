...
public class PlansActivity extends AppCompatActivity {
    public static final String TAG = PlansActivity.class.getSimpleName();
    ...
    private void getPlans() {
        ...
        productsService.getPlansProducts(new Callback() {
            @Override
                ...
                if(products.isEmpty()){
                    ...
                    PlansActivity.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(PlansActivity.this);
